...
function twentysixteen_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'category_title_color',
            array(
                'label'   => __( 'Category title Color', 'twentysixteen' ),
                'section' => 'colors',
            )
        )
    );
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_menu_background_color',
            array(
                'label'   => __( 'Header menu Background Color', 'twentysixteen' ),
                'section' => 'colors',
            )
        )
    );
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_menu_text_color',
            array(
                'label'   => __( 'Header menu text Color', 'twentysixteen' ),
                'section' => 'colors',
            )
        )
    );
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_menu_text_linked_color',
            array(
                'label'   => __( 'Header menu text inner Color', 'twentysixteen' ),
                'section' => 'colors',
            )
        )
    );
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_sub_menu_background_color',
            array(
                'label'   => __( 'Header sub menu background  Color', 'twentysixteen' ),
                'section' => 'colors',
            )
        )
    );
...
function twentysixteen_color_scheme_css() {
	...
	$colors = array(
		...
		'header_menu_background_color' => $color_scheme[5],
        'header_menu_text_color' => $color_scheme[6],
        'header_menu_text_linked_color' => $color_scheme[7],
        'header_sub_menu_background_color' => $color_scheme[8],
        'header_background_color' => $color_scheme[9],
        'category_title_color' => $color_scheme[10],
...
.site-header-menu, .featuretitle, .featuretag , .search-submit , .search-submit:hover {
			background-color: {$colors['header_menu_background_color']};
		}
	...
	#menu-top>li>a, #menu-top>li>a:hover{
			...
			color: {$colors['header_menu_text_linked_color']};
			

		}
		
				.menu-open #menu-top .toggled-on.sub-menu,		#menu-top > li ul, #menu-top > li ul a {
    background-color: {$colors['header_sub_menu_background_color']};
    }
...
.site-header {
	...
	@media screen and (min-width: 56.875em) {
		.item_block_inner a:hover {
			color: {$colors['header_menu_background_color']};
		}
...
function twentysixteen_color_scheme_css_template() {
	$colors = array(
        ...
        'header_menu_background_color'=> '{{ data.header_menu_background_color }}',
        'header_menu_text_color'=> '{{ data.header_menu_text_color }}',
        'header_menu_text_linked_color'=> '{{ data.header_menu_text_linked_color }}',
        'header_sub_menu_background_color'=> '{{ data.header_sub_menu_background_color }}',
        'header_background_color'=> '{{ data.header_background_color }}',
        'category_title_color'=> '{{ data.category_title_color }}',
 ...
 * @see wp_add_inline_style()
 */
function twentysixteen_header_menu_background_color() {
    $color_scheme  = twentysixteen_get_color_scheme();
    $default_color = $color_scheme[5];
    $header_menu_background_color   = get_theme_mod( 'header_menu_background_color', $default_color );
    $category_title_color   = get_theme_mod( 'category_title_color', $default_color );
    $header_menu_text_color   = get_theme_mod( 'header_menu_text_color', $default_color );
    $header_menu_text_linked_color   = get_theme_mod( 'header_menu_text_linked_color', $default_color );
    ...
    // Don't do anything if the current color is the default.
    if ( $header_menu_background_color === $default_color ) {
        return;
    }

    $css = '
		/* Custom Color */
body.menu-open .main-navigation .back-button, .site-header , .site-header-main .sub-menu , .featuretitle, .featuretag , .search-submit , .search-submit:hover, #moreCategories.blue-stripe {
			...
			.item_block_inner  a:hover {
				...
				#menu-top>li>a, #menu-top>li:hover>a, body.menu-open .main-navigation .back-button {
    ...
    color: '.$category_title_color.';
			...
			color:'.$header_menu_text_linked_color.'!important;
...
add_action( 'wp_enqueue_scripts', 'twentysixteen_header_menu_background_color', 11 );
