...
$array_list = array(
    ...
    'Pro' => array(  'title' => 'Critic Reviews:<span data-value="critics_reviews_popup" class="critic_popup nte_info nte_right"></span>', 'id' => 'review_scroll', 'class' => 'single pro_review'),
