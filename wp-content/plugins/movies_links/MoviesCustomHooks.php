...
class MoviesCustomHooks {
    ...
    public function add_actors($campaign = array(), $post = array(), $valid_actors = array()) {
        ...
        // $this->update_forebears($campaign, $post, $options, $valid_actors);
    ...
    private function update_forebears($campaign, $post, $options, $valid_actors = array()) {
