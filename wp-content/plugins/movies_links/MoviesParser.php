...
class MoviesParser extends MoviesAbstractDB {
    ...
    public $campaign_modules = array('cron_urls', 'gen_urls', 'arhive', 'parsing', 'links', 'critics', 'update');
                ...
                foreach ($items as $item) {
                    ...
                    if ($code) {
                        ...
                        if (!$preview) {
                            ...
                            if ($add_post) {
                                $this->log_info($log_message, $cid, $id, 5);
                            } else {
                                $this->log_error($log_message, $cid, $id, 5);
                            }
                        }
                    } else {
                        if ($debug) {
