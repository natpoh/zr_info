...
class CriticSearch extends AbstractDB {
    ...
    public $facet_data = array(
        ...
        'ratings' => array(
            ...
            'childs' => array(
                ...
                'rdb' => array('title' => 'Douban', 'facet' => 'rating', 'eid' => 'edb', 'titlesm' => 'Douban', 'name_pre' => 'DB ', 'filter_pre' => 'Douban', 'max_count' => 110, 'multipler' => 10, 'group' => 'rating', 'icon' => 'douban', 'sorted' => 1, 'tabs' => array('movies', 'international', 'ethnicity'), 'hide' => 1, 'minus' => 1, 'zero' => 1,),
        ...
        'actorsdata' => array(
            ...
            'childs' => array(
                ...
                // actors simpson
                'actors_simpson' => array('title' => 'Simpson',),
                'simall' => array('parent' => 'actors_simpson', 'title' => 'Simpson', 'facet' => 'rating', 'titlesm' => 'Simpson', 'name_pre' => 'Simpson ', 'filter_pre' => 'Simpson', 'multipler' => 100, 'max_count' => 110, 'group' => 'rating', 'sorted' => 1, 'minus' => 1,),
                'simstar' => array('parent' => 'actors_simpson', 'title' => 'Simpson Star', 'facet' => 'rating', 'titlesm' => 'Simpson Star', 'name_pre' => 'Simpson Star ', 'filter_pre' => 'Simpson Star', 'multipler' => 100, 'max_count' => 110, 'group' => 'rating', 'sorted' => 1, 'minus' => 1,),
                'simmain' => array('parent' => 'actors_simpson', 'title' => 'Simpson Main', 'facet' => 'rating', 'titlesm' => 'Simpson Main', 'name_pre' => 'Simpson Main ', 'filter_pre' => 'Simpson Main', 'multipler' => 100, 'max_count' => 110, 'group' => 'rating', 'sorted' => 1, 'minus' => 1,),
                // Actors country
        ...
        'dirsdata' => array(
            ...
            'childs' => array(
                ...
                'dircast' => array('filter' => 'director_cast', 'parent' => 'dirs', 'title' => 'Casting director', 'name_pre' => 'Casting dir: ', 'placeholder' => 'casting', 'minus' => 1,),
        ...
        'findata' => array(
            ...
            'childs' => array(
                ...
                'boxworld' => array('title' => 'Worldwide Box Office', 'facet' => 'rating', 'eid' => 'eboxworld', 'titlesm' => 'Worldwide', 'name_pre' => 'BOW ', 'filter_pre' => 'Worldwide Box Office', 'group' => 'indie', 'hide' => 1, 'sorted' => 1,),
                'boxint' => array('title' => 'International Box Office', 'facet' => 'rating', 'eid' => 'eboxint', 'titlesm' => 'International', 'name_pre' => 'International ', 'filter_pre' => 'International Box Office', 'group' => 'indie', 'hide' => 1, 'sorted' => 1,),
                'boxusa' => array('title' => 'Domestic Box Office', 'facet' => 'rating', 'eid' => 'eboxusa', 'titlesm' => 'Domestic', 'name_pre' => 'Domestic ', 'filter_pre' => 'Domestic Box Office', 'group' => 'indie', 'hide' => 1, 'sorted' => 1,),
            ),
        ),
        'popdata' => array(
            'title' => 'Popularity',
            ...
            'childs' => array(
                ...
                'pop' => array('title' => 'ZR Critics', 'eid' => 'epop', 'titlesm' => 'Reviews', 'name_pre' => 'Reviews ', 'filter_pre' => 'Reviews', 'group' => 'pop', 'icon' => 'zr', 'sorted' => 1, 'no_data' => 1,),
        ...
        'wokedata' => array(
            ...
            'childs' => array(
                ...
                'div' => array('title' => 'Diversity %', 'eid' => 'ediversity', 'def' => 'desc', 'group' => 'woke', 'no_data' => 1, 'sorted' => 1, 'tabs' => array('movies', 'international', 'ethnicity'),),
                'fem' => array('title' => 'Female %', 'eid' => 'efemale', 'def' => 'desc', 'group' => 'woke', 'no_data' => 1, 'sorted' => 1, 'tabs' => array('movies', 'international', 'ethnicity'),),
                // IMDB Keywords
                ...
                'bechdeltest' => array('title' => 'BechdelTest', 'facet' => 'select', 'eid' => 'ebechdeltest', 'titlesm' => 'BechdelTest', 'name_pre' => 'BechdelTest ', 'filter_pre' => 'BechdelTest', 'max_count' => 5, 'multipler' => 1, 'group' => 'woke', 'hide' => 1, 'sorted' => 1, 'minus' => 1, 'tabs' => array('movies', 'international', 'ethnicity'),),
                ...
                'mediaversity' => array('title' => 'MediaVersity A-F', 'eid' => 'emedia', 'facet' => 'select', 'titlesm' => 'MediaVersity', 'name_pre' => 'MediaVersity ', 'filter_pre' => 'MediaVersity', 'max_count' => 20, 'multipler' => 1, 'group' => 'woke', 'hide' => 1, 'minus' => 1, 'tabs' => array('movies', 'international', 'ethnicity')),
                //  'worthit' => array('title' => 'WorthItOrWoke', 'eid' => 'eworthit', 'facet' => 'select', 'titlesm' => 'WorthIt', 'name_pre' => 'WorthItOrWoke ', 'filter_pre' => 'WorthItOrWoke', 'max_count' => 5, 'multipler' => 1, 'group' => 'woke', 'hide' => 1, 'sorted' => 1, 'minus' => 1, 'tabs' => array('movies', 'international', 'ethnicity')),
                // Audience  
                ...
                'auvote' => array('title' => 'SUGGESTION', 'eid' => 'eauvote', 'facet' => 'select', 'titlesm' => 'SUGGESTION', 'name_pre' => 'AU ', 'filter_pre' => 'Audience SUGGESTION', 'max_count' => 6, 'multipler' => 1, 'icon' => 'vote', 'hide' => 1, 'group' => 'woke', 'minus' => 1,),
        ...
        'sortdata' => array(
            ...
            'childs' => array(
                ...
                'echerry' => array('tabs' => array('movies', 'international', 'ethnicity'),),
    ...
    public $search_filters = array(
        ...
        'sphoto' => array(
            'exist' => array('key' => 1, 'title' => 'Has Photo'),
        ),
        'auvote' => array(
        ...
        if (isset($facet['tabs'])) {
            ...
            foreach ($facet['tabs'] as $tab) {
                ...
                if (isset($facet['sorted'])) {
                    ...
                    $sort_append = array('title' => $facet['title'], 'def' => $def_sort, 'main' => $main, 'icon' => $icon, 'group' => $group, 'eid' => $eid);
    ...
    public function movies_facets_sql($facet_list, $filters, $match) {
        ...
        foreach ($facet_list as $facet) {
            ...
            if ($facet == 'release') {
            ...
            } else if ($facet == 'actors_simpson') {
                // Simpson actor logic
                $name_active = $this->get_active_race_facet($filters);
                if (isset($this->facet_data['actorsdata']['race_simpson'][$name_active])) {
                    $filter_name = $this->facet_data['actorsdata']['race_simpson'][$name_active];
                ...
                $filters_and = $this->get_filters_query($filters, 'race');
                $sql_arr[$facet] = "SELECT GROUPBY() as id, COUNT(*) as cnt" . $filters_and['select'] . " FROM movie_an WHERE id>0" . $filters_and['filter'] . $match
    ...
    public function get_filters_query($filters = array(), $exlude = array(), $query_type = 'movies', $curr_filter = '', $aid = 0) {
        ...
        if ($query_type == 'filters') {
            $select_and .= ", IF(publish OR aid={$aid},1,0) as upub";
            $filters_and .= " AND upub=1";
        } else {
        ...
        if ($query_type == 'critics') {
            ...
            if (isset($filters['state'])) {
                ...
                if (is_array($filters['state'])) {
                    $filters_and .= $this->filter_multi_value('state', $filters['state'], true);
                } else {
                    $filters_and .= $this->filter_multi_value('state', $filters['state'], true);
                }
            }
            ...
            foreach ($filters as $key_data => $value) {
                ...
                if ($query_type == 'filters') {
                    ...
                    if (isset($curr_facet['facet']) && $curr_facet['facet'] == 'rating') {
                        ...
                        if ($and) {
                            if ($minus) {
                                $filters_and .= $this->filter_multi_value($key, $value, true, $minus, true, false, true, true);
                            } else {
                                $filters_and .= $this->filter_multi_value($key, $value, true, $minus, true, false, true, true);
                            }
                        } else {
            ...
            if (sizeof($provider_valid_arr)) {
                if (!$not) {
                    if ($multi) {
                        if ($split_all) {
                            foreach ($provider_valid_arr as $provider) {
                                $filters_and .= sprintf(" AND $and(%s)=%s", $key, $provider);
                            }
                        } else {
                    ...
                    if ($multi) {
                        if ($split_all) {
                            foreach ($provider_valid_arr as $provider) {
                                $filters_and .= sprintf(" AND $and_not(%s)!=%s", $key, $provider);
                            }
                            $filters_and .= $and_any;
                        } else {
    ...
    public function get_last_critics($a_type = -1, $limit = 10, $movie_id = 0, $start = 0, $tags = array(), $meta_type = array(), $min_rating = 0, $vote = 0, $min_au = 0, $max_au = 0, $vote_type = 0) {
        ...
        if ($vote_type > 0) {
            if ($vote_type == 1) {
                ...
                // $filters_and .= " AND filter=1";
                $filters_and .= " AND aurating>0 AND aurating<2.3";
            }
        }
