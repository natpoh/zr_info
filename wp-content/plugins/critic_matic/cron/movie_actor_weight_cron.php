...
/*
 * /wp-content/plugins/critic_matic/cron/movie_actor_weight_cron.php?p=8ggD_23sdf_DSF&debug=1
 */
...
$cm = new CriticMatic();
$cron_name = 'movie_actor_weight_cron_' . $type;
...
$maw = new MoviesActorWeight();
$maw->run_cron($type, $count, $debug, $force);
