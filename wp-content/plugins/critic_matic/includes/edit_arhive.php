<h2><a href="<?php print $url ?>"><?php print __('Critic parsers Arhive') ?></a>. <?php print __('Edit') ?></h2>
            ...
            <fieldset>
                ...
                <label class="inline-edit-interval">
                    ...
                    <select name="interval" class="interval">
                        ...
                        foreach ($this->cp->update_interval as $key => $name) {
                ...
                <?php else: ?>
                    ...
                    <label class="inline-edit-interval"> 
                        ...
                        <select name="random" class="tor_d">
                            <?php
                            foreach ($this->cp->parsing_type as $key => $name) {
        ...
        <div class="cm-edit inline-edit-row">
            <fieldset>
                <label>
                    ...
                    <?php $first_url = $this->cp->get_last_url($cid); ?>
