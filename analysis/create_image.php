...
$watermark_src = ABSPATH.'analysis/images/mask.png';
$noimage_src = ABSPATH.'analysis/images/noimage.png';
    ...
    if (!$result) {
        ...
        if ($title) {
            ...
            if ($type == 'VideoGame') {
                $pointsize = 26;
                $pointsize_year = 18;
                $fontfile = ABSPATH.'analysis/8-bit pusab.ttf';
            } else {
                $fontfile = ABSPATH.'analysis/HOLLYWOODSTARFIRE.ttf';
            }
...
$imgsource = ABSPATH.'analysis/img_final_tmdb/' . $number . '.jpg';
...
if ($gender) {
    if ($gender == 'Male') {
        $img_gender = ABSPATH.'analysis/images/mask-m.png';
    } else if ($gender == 'Female') {
        $img_gender = ABSPATH.'analysis/images/mask-f.png';
    }
}
...
$font = ABSPATH.'analysis/8-bit pusab.ttf';
